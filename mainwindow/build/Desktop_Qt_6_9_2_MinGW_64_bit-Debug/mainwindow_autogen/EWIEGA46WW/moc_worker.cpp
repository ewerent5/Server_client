...
void Worker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Worker::*)(int )>(_a, &Worker::progress, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Worker::*)(bool , const QString & )>(_a, &Worker::finished, 1))
            return;
    }
}
...
// SIGNAL 1
void Worker::finished(bool _t1, const QString & _t2)
{
